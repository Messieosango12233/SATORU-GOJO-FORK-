...
module.exports = {
  ...
  config: {
    ...
    shortDescription: "☆𝙎𝘼𝙏𝑂𝑅𝑈 𝔤𝔬𝔧𝔬  𝐵𝑂𝑇༆",
  ...
  onStart: async function({ api, event, args }) {
    ...
    try {
      ...
      if (!np) {
        ...
        return api.sendMessage('☆𝙎𝘼𝙏𝑂𝑅𝑈 𝔤𝔬𝔧𝔬  𝐵𝑂𝑇
━━━━━━━━━━━━━━━━
𝔰𝔞𝔩𝔲𝔱, 𝔧𝔢 𝔰𝔲𝔦𝔰 𝔩'𝔦𝔫𝔱𝔢𝔩𝔩𝔦𝔤𝔢𝔫𝔠𝔢 𝔞𝔯𝔱𝔦𝔣𝔦𝔠𝔦𝔩𝔩𝔢 ℭℜéé 𝔭𝔞𝔯 𝔪𝔢𝔰𝔰𝔦𝔢 𝔬𝔰𝔞𝔫𝔤𝔬 𝔮𝔲𝔢 𝔭𝔲𝔦𝔰-𝔧𝔢 𝔣𝔞𝔦𝔯𝔢 𝔭𝔬𝔲𝔯 𝔳𝔬𝔲𝔰 ? ━━━━━━━━━━━━━━━━', event.threadID, event.messageID);
      ...
      gpt({
        ...
        messages: [
...

          {
            ...
            content: `💬 𝙃𝙞 𝙄'𝙢 SATORU GOJO  𝙫𝙞𝙧𝙩𝙪𝙖𝙡 𝙖𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩. 𝙒𝙝𝙖𝙩 𝙘𝙖𝙣 𝙞 𝙙𝙤 𝙛𝙤𝙧 𝙮𝙤𝙪 🤓?`
